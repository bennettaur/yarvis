...
saved entries never pushes history out of view. Arrows move the selection,
Enter copies the highlighted row and closes the palette, Esc dismisses it.
Entries can be labelled, tagged, and
